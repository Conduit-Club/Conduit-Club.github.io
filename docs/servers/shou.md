...
- 建造与大范围编辑请前往 [Create 创造建筑服](/servers/create/)。
...
<div className="cc-screenshot-gallery">
  <figure>
    <img src="/img/screenshots/shou/campus-lake.jpg" alt="SHOU 建筑展示服校园湖畔与高层建筑" loading="lazy" />
